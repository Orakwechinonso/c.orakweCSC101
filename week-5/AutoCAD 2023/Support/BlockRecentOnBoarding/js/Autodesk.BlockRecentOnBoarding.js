...
var AcBlockRecent;
(function (AcBlockRecent) {
    var Interop;
    (function (Interop) {
        var getIsLoggedIn = function() {
            return new Promise( (resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.getIsLoggedIn',
                    functionParams: {}
                }), (result) => {
        ...
        var closeBrowser = function () {
            execAsync(JSON.stringify({
                functionName: 'AcBlockRecent_Interop.closeBrowser',
                functionParams: {}
            }), () => {}, (result) => {
                if (typeof(reject) !== 'function') {
                    return;
        ...
        var getColorTheme = function () {
            return new Promise( (resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.getColorTheme',
                    functionParams: {}
                }), (result) => {
                    if (typeof(resolve) !== "function") {
                        return;
        ...
        var getTabName = function () {
            return new Promise( (resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.getTabName',
                    functionParams: {}
                }), (result) => {
                    if (typeof(resolve) !== "function") {
                        return;
        ...
        var getLanguage = function () {
            return new Promise( (resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.getLanguage',
                    functionParams: {}
                }), (result) => {
                    if (typeof(resolve) !== "function") {
                        return;
        ...
        var signIn = function () {
            return invokeAcadFunction({
                functionName: 'AcBlockRecent_Interop.signIn',
                functionParams: {},
        ...
        var launchHelp = function (strHelpId) {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.launchHelp',
        ...
        var getIsBlockSyncFolderSetToCloudStorage = () => {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: 'AcBlockRecent_Interop.getIsBlockSyncFolderSetToCloudStorage',
                    functionParams: {}
                }), (result) => {
                    if (typeof(resolve) !== "function") {
                        return;
        ...
        var showStorageDialog = function (title, default_str) {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: "AcBlockRecent_Interop.showStorageDialog",
        ...
        var setBlockSyncFolder = function (strPath) {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: "AcBlockRecent_Interop.setBlockSyncFolder",
        ...
        var getIsStateLocked = () => {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: "AcBlockRecent_Interop.getIsStateLocked",
                    functionParams: {}
                }), result => {
                    if (typeof(resolve) !== "function")
                        return;
        ...
        var setIsStateLocked = (lock) => {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: "AcBlockRecent_Interop.setIsStateLocked",
        ...
        var updatePalette = function () {
            return new Promise((resolve, reject) => {
                execAsync(JSON.stringify({
                    functionName: "AcBlockRecent_Interop.updatePalette",
                    functionParams: {}
                }), result => {
                    if (typeof(resolve) !== "function")
                        return;
        ...
        Interop.updatePalette = updatePalette;
        const showGuideDialog = () => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.showGuideDialog",
                functionParams: {},
                invokeAsCommand: false
            });
        };
        ...
        const setIsOnBoardingCompleted = () => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.setOnBoardingCompleted",
                functionParams: {},
                invokeAsCommand: false
            });
        };
        ...
        const getBlockSyncFolderFromServer = (timeout) => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.getBlockSyncFolderFromServer",
        ...
        const showConsentDialog = () => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.showConsentDialog",
                functionParams: {},
                invokeAsCommand: false
            });
        };
        Interop.showConsentDialog = showConsentDialog;
        const getConsentStatus = (timeout) => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.getConsentStatus",
                functionParams: {TIMEOUT: timeout},
                invokeAsCommand: false
            });
        };
        ...
        const setConsentStatus = (status) => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.setConsentStatus",
        ...
        const getIsBlockSyncFolderCustomizedToLocal = () => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.getIsBlockSyncFolderCustomizedToLocal",
                functionParams: {},
                invokeAsCommand: false
            });
        };
        ...
        Interop.walkOnBoarding = () => {
            return invokeAcadFunction({
                functionName: "AcBlockRecent_Interop.walkOnBoarding",
                functionParams: {},
                invokeAsCommand: false
            });
        };
    })(Interop || (Interop = {}));
    AcBlockRecent.Interop = Interop;
})(AcBlockRecent || (AcBlockRecent={}));